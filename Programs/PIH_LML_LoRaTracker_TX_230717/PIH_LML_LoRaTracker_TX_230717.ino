...
#define dateproduced "230717"
#define aurthorname "Stuart Robinson"

//#define LoRaTracker_Locator2
#define PIHTracker3
...
270617 - Added definitions for Locator2
230717 - Added Debug mode to send test location
*/
...
#define RCPulseMode
#define Timeout
#define Debug                                //uses test values for Latitude and Longitude  
...
#define MinsToLost 5                         //minutes before lost mode automatically engaged.
...
void loop()
{
  ...
  if (gps.location.isUpdated() && gps.altitude.isUpdated())
  {
    ...
    #ifdef Debug                                  //so test location is shown on display
    delay(1000);
